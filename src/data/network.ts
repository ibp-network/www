...
const chainBlurb: Record<string, string> = {
  ...
  'ETH-Asset-Hub-Polkadot': 'EVM-compatible RPC on Asset Hub Polkadot. Use viem or ethers.js.',
  'ETH-Asset-Hub-Kusama':   'EVM-compatible RPC on Asset Hub Kusama.',
  'ETH-Asset-Hub-Paseo':    'EVM-compatible RPC on Asset Hub Paseo (testnet).',
